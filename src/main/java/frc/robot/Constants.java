...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(140.3978); //practicebot
   ...
   public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(159.0937); //practicebot
   ...
   public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(223.0819); //practicebot
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(245.0654); //practicebot
