...
public class HilltopSwerveControllerCommand extends CommandBase {
  ...
  public HilltopSwerveControllerCommand(
    ...
    m_trajectoryConfig = requireNonNullParam(trajectoryConfig, "trajectoryConfig", "SwerveControllerCommand");
    m_endPose = requireNonNullParam(endPose, "endPose", "SwerveControllerCommand");
    ...
    m_desiredRotation = () -> endPose.getRotation();
  ...
  public void initialize() {
    m_trajectory = getTrajectory(m_pose.get().getTranslation(), m_endPose.getTranslation(), m_trajectoryConfig);
    m_timer.reset();
    m_timer.start();
  }
  ...
  private static Trajectory getTrajectory(Translation2d start, Translation2d end, TrajectoryConfig config) {
  ...
  private static Rotation2d getTrajectoryRotation(Translation2d start, Translation2d end) {
